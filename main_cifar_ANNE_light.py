...
parser.add_argument('--step', default=0.03, type=float, metavar='st', help='delta step for increase knn radius. ')
    ...
    with torch.no_grad():
        ...
        if i>=args.warmup:
            ...
            if args.ssrset == "lcs":
                ...
                prediction_knn = fast_weighted_knn_ball( feature_bank[aknn_ids], feature_bank[aknn_ids], modified_label[aknn_ids], args.num_classes, chunks=args.chunks,   otsu_split=otsu_split, kmax=args.kmax, kmin1=args.kmin1, kmin2=args.kmin2, step=args.step )  # temperature in weighted KNN
                vote_y = torch.gather(prediction_knn, 1, modified_label[aknn_ids].view(-1, 1)).squeeze()

            elif args.ssrset == "full":
                ...
                prediction_knn = fast_weighted_knn_ball( feature_bank, feature_bank, modified_label, args.num_classes, chunks=args.chunks, otsu_split=otsu_split, kmax=args.kmax, kmin1=args.kmin1, kmin2=args.kmin2,  step=args.step )  # temperature in weighted KNN
